    ...
    <section id="mainpage">
        <nav class="large-3 medium-4 columns" id="actions-sidebar">
            <ul class="side-nav">
                ...
                <li><?=
                    $this->Form->postLink(
                            __('Delete'), ['action'=>'delete', $employee->id], ['confirm'=>__('Are you sure you want to delete # {0}?', $employee->id)]
                    )
                    ?></li>
        ...
        <div class="articles form large-9 medium-8 columns content">
            ...
            <fieldset>
                ...
                <a class="fancybox-effects-d" href="/img/upload/<?php echo $employee->image;?>" title="<?= h($employee->name)?>">
                    <img src="/img/upload/<?php echo $employee->image;?>" height="250" width="250" alt="Image">
                </a>
            </fieldset>
